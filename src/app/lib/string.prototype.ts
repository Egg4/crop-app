interface StringConstructor {
  random(length: number, charlist?: string): string;
}
...
String.random = function(length: number, charlist?: string) {
  var string = '';
...
String.prototype.toCamelCase = function(): string { 
  return this.replace(/(?:^\w|[A-Z]|-|\b\w)/g, 
    (ltr: string, idx: number) => idx === 0 ? ltr.toLowerCase() : ltr.toUpperCase()).replace(/\s+|-/g, '');
}
...
String.prototype.removeDiacritics = function(): string {
  return this.replace(/[^\u0000-\u007E]/g, (a) => { return diacriticsMap[a] || a; });
}